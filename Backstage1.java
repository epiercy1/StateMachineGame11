...
public class Backstage1 extends State{
private Model model;
	
	public Backstage1(Model model) {
		this.model = model;
	}

	@Override
	public String getDescription() {
		String description = "It is now opening night of the Musical one week later. You and the other girls are watching the show play out backstage. You see that your friend is alone. You and her have not seen eachother since you rejected her. You also see that the shy girl is also alone and this could be your chance to talk to her. Who would you like to talk to?";
		return description;
	}
	...
	public void processChoice(int choice) {
		if(choice == 1) {
			model.setCurrentState(StateType.GoodEnding1);
		}
		if(choice == 2) {
